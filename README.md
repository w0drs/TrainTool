...
[CatBoost](https://catboost.ai/) - Для использования градиентного бустинга.  
...
2. Создайте ветку для вашей фичи (`git checkout -b feature/Feature`).  
3. Закоммитьте ваши изменения (`git commit -m 'Add some feature'`).
4. Запушите в ветку (`git push origin feature/Feature`).
...
## 📞 Контакты
Дмитрий – @w0drs (телеграм) – golikd3210@gmail.com  
Ссылка на проект: https://github.com/w0drs/TrainTool  
